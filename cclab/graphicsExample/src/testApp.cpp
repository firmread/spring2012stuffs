...
//--------------------------------------------------------------
// global variable for the whole app


void testApp::setup(){
	counter = 0;
    // opportunity that it might start w/ random no. ,,, avoid that
	ofSetCircleResolution(50);
    // the same as 'smooth();' in processing
	ofBackground(255,255,255);
    // background color
	bSmooth = false;
	ofSetWindowTitle("graphics example");
    // head ( windows title of the program )
...
void testApp::update(){
    ...
    // counter += 0.033f;
    // same thing,, can do this as in processing
}
...
void testApp::draw(){
    ...
    // draw onto the object w/o have to create the font
    // throw variables to the screen just to see
